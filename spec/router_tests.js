...
describe('least hops router', function() {
    common_router_checks('leastHops');

    it('finds the path with fewer hops out of two routes', function() {
        var router = Routers.leastHops(relay('relay1', 1, 10), relay('relay2', 1, 0), relay('relay3', 2, 10, 1, 3, 4), relay('relay4', 2, 0), relay('relay5', 3, 0));
    ...
    it('finds the path with fewer hops out of three routes', function() {
        var router = Routers.leastHops(relay('relay0', 1, 0, 0, 2, 3), relay('relay1', 3, 10), relay('relay2', 2, 5, 1, 3, 4), relay('relay3', 4, 5), relay('relay4', 2, 0), relay('relay5', 3, 0), relay('relay6', 4, 0));
...
describe('shortest path router', function() {
    common_router_checks('shortestPath');

    it('finds the shorter path out of two routes', function() {
        var router = Routers.shortestPath(relay('relay1', 1, 10), relay('relay2', 1, 0), relay('relay3', 2, 10, 1, 3, 4), relay('relay4', 2, 0), relay('relay5', 3, 0));
    ...
    it('finds the shorter path out of three routes', function() {
        var router = Routers.shortestPath(relay('relay0', 1, 0, 0, 2, 3), relay('relay1', 3, 10), relay('relay2', 2, 5, 1, 3, 4), relay('relay3', 4, 5), relay('relay4', 2, 0), relay('relay5', 3, 0), relay('relay6', 4, 0));
        expect(names(router.route(relay('source', 0, 0), relay('target', 5, 0)))).toEqual(['source', 'relay0', 'relay5', 'relay6', 'target']);
    });
});
...
function common_router_checks(variant, trace) {
    ...
    it('works with a single relay and no route', function() {
        var router = Routers[variant](relay('relay1', 4, 0));
        expect(names(router.route(relay('source', 0, 0), relay('target', 2, 0), trace))).toBeNull();
    });

    it('works with a single relay and a route', function() {
        var router = Routers[variant](relay('relay', 1, 0));
    ...
    it('finds a single longer route', function() {
        var router = Routers[variant](relay('relay1', 1, 0), relay('relay2', 2, 0), relay('relay3', 3, 0), relay('relay4', 4, 0), relay('relay5', 5, 0));
    ...
    it('finds no route when the first hop is impossible', function() {
        var router = Routers[variant](relay('relay1', 2, 0), relay('relay2', 3, 0), relay('relay3', 4, 0), relay('relay4', 5, 0), relay('relay5', 6, 0));
    ...
    it('finds shorter hops', function() {
        var router = Routers[variant](relay('relay1', 1, 1), relay('relay2', 1, 0), relay('relay3', 2, 1), relay('relay4', 2, 0));
